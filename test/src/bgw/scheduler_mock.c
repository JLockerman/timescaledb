...
TS_FUNCTION_INFO_V1(bgw_db_scheduler_test_run_and_wait_for_scheduler_finish);
TS_FUNCTION_INFO_V1(bgw_db_scheduler_test_run);
TS_FUNCTION_INFO_V1(bgw_db_scheduler_test_wait_for_scheduler_finish);
TS_FUNCTION_INFO_V1(bgw_db_scheduler_test_main);
TS_FUNCTION_INFO_V1(bgw_job_execute_test);
